...
def make_args(input = None):
    ...
    parser.add_argument('--hid_d', type=int, default=128, help='The dimension of hidden layers')
    ...
    parser.add_argument('--kw', type=int, default=7, help='The initial value of kw_num')

    parser.add_argument('--repeat', type=int, default=10, help='The times of repeat')    

    parser.add_argument('--epochs_num', dest='epochs_num', default=100, type=int,
