...
from torch_geometric.utils import structured_negative_sampling #add_self_loops, degree,k_hop_subgraph, to_undirected, 
...
class Trainer(object):
    ...
    # def de_test(self, qX, ans, topk, verbose=False):
    #     self.model.eval()

    #     node_emb = self.model.forward(self.X, self.edge_index)
        
    #     de_emb = self.model.decoder(node_emb)

    #     avg_hit = eval_Z(de_emb, qX, ans, k=topk, verbose=verbose)
